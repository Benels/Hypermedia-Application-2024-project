    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:py-6 md:pb-4">
      ...
      <div ref="navbarMenu" class="shadow-md md:shadow-none hidden w-full md:block md:w-auto rounded-xl z-20 bg-dropdownMenu">
        <ul class="text-lg flex flex-col font-medium px-4 pb-4 md:p-0 mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
          ...
          <li>
            <NuxtLink to="/our_women" :class="currentRoute === 'our_women' ? 'text-red underline underline-offset-4 decoration-2' : '' " class="hover:text-red block py-2 px-3 rounded md:border-0 md:p-0">Our Women</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/contact_us" :class="currentRoute === 'contact_us' ? 'text-red underline underline-offset-4 decoration-2' : '' " class="hover:text-red block py-2 px-3 rounded md:border-0 md:p-0">Contact Us</NuxtLink>
          </li>
        </ul>
      </div>
    </div>
